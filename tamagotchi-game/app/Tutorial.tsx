...
export function Tutorial({Styles, isVisible}) {
    ...
    return (<View style={Styles.tutorial}>
        ...
        <div>
            3.  <Image source={require('../assets/images/game-images/buttons-for-tutorial.png')} style={Styles.tutorialScreenshot} resizeMode='contain'/> are used to interact with your chosen pet.
        </div>
        <div>
        ...
        <div>
            5.  <Image source={require('../assets/images/game-images/options-button.png')} style={Styles.tutorialButtonImage} resizeMode='contain'/> to view stats, change the screen background more.
        </div>
        <div>
            6. Have fun!
        </div>
        ...
        <div/>
        <div>
            Credits: @fincho, @cro, @logthatdata, [other artists go here]
        </div>
        </Text>
    </View>)
}